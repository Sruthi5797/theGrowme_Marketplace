      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between px-6 lg:px-12 py-4">
        ...
        <div className="flex items-center gap-4">
          <Link href="/professional-portal">
            <button className="bg-gradient-to-r from-primary via-pink-400 to-rose-400 px-8 py-3 rounded-full hover:shadow-lg hover:scale-105 transition-all duration-200 font-extrabold text-neutral-50 text-base">
              I am a Professional
            </button>
          </Link>
        </div>
